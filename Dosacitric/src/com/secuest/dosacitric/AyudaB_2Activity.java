...
public class AyudaB_2Activity extends AppCompatActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String stringCuerpo4 = "Zona Alta <font color=#ff6600> (A%)</font>: Representa el porcentaje de vegetación a tratar por las boquillas abiertas situadas en la zona alta del equipo (nA).";
		String stringCuerpo5 = "Zona Media <font color=#ff6600> (M%)</font>: Representa el porcentaje de vegetación a tratar por las boquillas abiertas situadas en la zona media del equipo (nM).";
		String stringCuerpo6 = "Zona Baja <font color=#ff6600> (B%)</font>: Representa el porcentaje de vegetación a tratar por las boquillas abiertas situadas en la zona baja del equipo (nB).";
