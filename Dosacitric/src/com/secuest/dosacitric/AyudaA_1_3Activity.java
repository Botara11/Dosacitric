...
public class AyudaA_1_3Activity extends AppCompatActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String stringCuerpo1 = "- <font color=#ff6600>Producto a aplicar:</font> Se elegirá el producto que se vaya a aplicar entre: <i>acaricidas (1), fungicidas (2), insecticidas (3), abonos foliares (4) y fitorreguladores (5)</i>. Si se van a aplicar dos o más productos en el mismo tratamiendo, se elegirá aquella opción que tenga menor número entre paréntesis.";
		...
		String stringCuerpo3 = "<i><font color=#ff6600>La forma de actuación de un producto</font> se puede obtener directamente leyendo la etiqueta del envase o de las páginas web del Instituto Valenciano de Investigaciones agrarias (IVIA) o del Ministerio de Agricultura, Alimentación y Medio Ambiente.<i>";
		String stringCuerpo4 = "- <font color=#ff6600>Zona crítica a tratar:</font> En este punto hay que especificar la zona objetivo del tratamiento, es decir, la zona del árbol donde se ubica la plaga o enfermedad a tratar. Las opciones son: <i>zona interior (1), zona interior y exterior (2) y zona exterior (3)</i>. Si se van a tratar dos o más plagas o enfermedades, se eligirá aquella opción que tenga menor número entre paréntesis.";
		String stringCuerpo5 = "Se indicará la <i><font color=#ff6600>temperatura ambiente, humedad relativa y velocidad del viento</font><i>, eligiendo uno de los intervalos establecidos. Si la temperatura es superior a 30ºC, llueve, o la velocidad del viento es superior a 3 m/s, se recomienda no realizar el tratamiento, por tanto, la aplicación mostrará una alerta en la hoja de resultados (R) y no proporcionará resultado del Volumen de aplicación recomendado.";
