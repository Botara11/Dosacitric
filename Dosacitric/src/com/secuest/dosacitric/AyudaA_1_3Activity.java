...
public class AyudaA_1_3Activity extends AppCompatActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String stringCuerpo4 = "Se indicará la <i><font color=#ff6600>temperatura ambiente, humedad relativa y velocidad del viento</font><i>, eligiendo uno de los intervalos establecidos. Si la temperatura es superior a 30ºC, llueve, o la velocidad del viento es superior a 3 m/s, se recomienda no realizar el tratamiento, por tanto, la aplicación mostrará una alerta en la hoja de resultados (R) y no proporcionará resultado del Volumen de aplicación recomendado.";
