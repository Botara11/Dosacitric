...
public class AyudaIndice extends AppCompatActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String stringCuerpo6 = "se accederá a una pantalla donde se podrán dar de alta, eliminar y visualizar las boquillas propias del usuario.";
		//String stringCuerpo7 = "a una pantalla donde se podrán dar de alta, eliminar y visualizar las boquillas propias del usuario.";
