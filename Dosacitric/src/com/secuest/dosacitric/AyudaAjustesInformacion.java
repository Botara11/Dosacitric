...
public class AyudaAjustesInformacion extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String stringCuerpo8 = "<font color=#E65F00> DOSACITRIC </font> se ha elaborado a partir de los resultados obtenidos en los proyectos de investigación PULVERXACT<sup>1</sup> y OPTIDOSA<sup>2</sup>, llevados a cabo por el grupo de investigación de la Unidad de Mecanización y Tecnología Agraria de la Universidad Politécnica de Valencia."; 
