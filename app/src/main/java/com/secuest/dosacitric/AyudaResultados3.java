...
public class AyudaResultados3 extends AppCompatActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String stringCuerpo8 = "- Zona Media: Representa el modelo de boquilla instalado en la zona media del equipo (Fabricante.Modelo).";
		String stringCuerpo9 = "- Zona Baja: Representa el modelo de boquilla instalado en la zona baja del equipo (Fabricante.Modelo).";
		String stringCuerpo10 = "Representa el caudal aplicado por el equipo  en L/min, obtenido a partir de los datos introducidos en <font color=#ff6600> DOSACITRIC</font>.";
