...
public class ParteC implements Serializable{
	...
	public String ModeloZonaAltaSeleccionado;
	public String ModeloZonaMediaSeleccionado;
	public String ModeloZonaBajaSeleccionado;
	...
	public void rellenarC1(float AnchoCalle,
		...
		this.NumeroBoquillasZona = NumeroBoquillasZona; // Z.Alta, Z.Media y Z.Baja
	...
	public void rellenarC4(String item) {
		ModeloZonaAltaSeleccionado = item;
	}
	public void rellenarC5(String item) {
		ModeloZonaMediaSeleccionado = item;
	}
	public void rellenarC6(String item) {
